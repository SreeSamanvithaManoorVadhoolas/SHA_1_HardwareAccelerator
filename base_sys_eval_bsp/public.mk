...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../base_sys.sopcinfo
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1704925762
SOPC_SYSID_FLAG += --timestamp=1704925762
ELF_PATCH_FLAG  += --timestamp 1704925762
...
# setting hal.stderr is sys_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev sys_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is sys_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev sys_jtag_uart
...
# setting hal.stdout is sys_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev sys_jtag_uart
